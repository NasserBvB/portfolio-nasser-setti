import { Heading, Image, PseudoBox, Stack, Text, useColorMode } from "@chakra-ui/core";
...
export default function Welcome() {
    ...
    return (
        <div style={{ width: "100%", "display": "flex", "justifyContent": "center", height: "90vh" }}>
            <PseudoBox role="group" maxW="xl" minW='md' height="80%" overflow="hidden" p={2} cursor="pointer" bg={bg[colorMode]} boxShadow="lg" borderRadius="50px" padding="100px" >
