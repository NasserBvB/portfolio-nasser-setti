  ...
  return (
    <Container id="about">
      <div className="about-text">
        ...
        <ScrollAnimation animateOnce animateIn="fadeInLeft" delay={0.2 * 1000}>
          <p>
        ...
        <div className="hard-skills">
          <div className="hability">
            <ScrollAnimation animateOnce animateIn="fadeInUp" delay={0.1 * 1000}>
          ...
          <div className="hability">
            <ScrollAnimation animateOnce animateIn="fadeInUp" delay={0.3 * 1000}>
          ...
          <div className="hability">
            <ScrollAnimation animateOnce animateIn="fadeInUp" delay={0.5 * 1000}>
          ...
          <div className="hability">
            <ScrollAnimation animateOnce animateIn="fadeInUp" delay={0.7 * 1000}>
      ...
      <div className="about-image">
        <ScrollAnimation animateOnce animateIn="fadeInRight" delay={0.6 * 1000}>
          <img src="/nasser.jpg" alt="Imagem de perfil" />
        </ScrollAnimation>
      </div>
    </Container>
  );
