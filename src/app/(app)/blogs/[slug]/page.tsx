      ...
      <div className="flex flex-col md:flex-row gap-4">
        <div className="flex flex-col w-full md:w-3/5">
          ...
          <div className="flex justify-between items-center flex-wrap">
            <p className="text-muted-foreground mb-4">Published {formatDate(blog.createdAt)}</p>
            <p className="text-muted-foreground mb-4">Last Modified {formatDate(blog.updatedAt)}</p>
          </div>
        ...
        {related.length > 0 && (
          <div className="w-full md:w-2/5 flex flex-col">
            <h3>
              Related Blogs <span className="text-muted-foreground">({related.length})</span>
            </h3>
            {related.map((blog) => (
